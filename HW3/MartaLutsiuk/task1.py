...
print(f"Number of occurence better = {zen_of_python.count("better")}")
print(f"Number of occurence never = {zen_of_python.count("never")}")
print(f"Number of occurence is = {zen_of_python.count("is")}")

# display all text in uppercase (all letters in uppercase)
print(f"Text in upper = {str.upper(zen_of_python)}" )
